...
ka.login(token="")
ka.loginResult()
print "Ka-Login Success\n"

kb = LINETCR.LINE()
#kb.login(qr=True)
kb.login(token="")
kb.loginResult()
print "Kb-Login Success\n"

ko = LINETCR.LINE()
#ko.login(qr=True)
ko.login(token="")
ko.loginResult()
print "Ko-Login Success\n"

ke = LINETCR.LINE()
#ke.login(qr=True)
ke.login(token="")
ke.loginResult()
print "Ke-Login Success\n"
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ...
                kr.sendText(msg.to,"TC4 Hadiir  \(ˆ▿ˆ)/")
                ks.sendText(msg.to,"TC5 Hadiir  \(ˆ▿ˆ)/")
                ka.sendText(msg.to,"TC6 Hadiir  \(ˆ▿ˆ)/")
                kb.sendText(msg.to,"TC7 Hadiir  \(ˆ▿ˆ)/")
                ko.sendText(msg.to,"TC8 Hadiir  \(ˆ▿ˆ)/")
                ke.sendText(msg.to,"Hadiir Semua Kapten  \(ˆ▿ˆ)/")
