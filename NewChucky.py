...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="Es2q08NK8YSCSURSWduf.a2jtIjiEA6OEd8Hqa7J97W.D0d1ufi4lrdXDz2ISrQF5oIu3N1ENjy5t3pxBr7hBxY=")
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token="EsgkW4ZKqxBfJvVBbYV9.uYJ6edxIZ8C4Q3/KwSdyUq.0Q0Zy/jjljdv+ciCCQ9VpHt8ArAE6gdoTmMtwBXxH1A=")
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token="Esm4rB6tuJge4vzn8rye.XGWn96LGOFJ1a1yTFcngFG.9MZPcgHMWnS4Luq48131CIkkuFFfMduIKrs2jKSDWK8=")
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token="Es8gHxqFHYCWmzgWfgD6.nAooghU4e54qsOYN8g+MnG.+8Fu0MvCLFcEFx+lgoluq9WxX+fchAwhw+6Zq38BxhA=")
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token="EsKXCWOrqxK3FerHd9Z9.VMasV1yUslq2OxwUXK8HUq.SnZFjXzZuaLjUqcV54FVrlWlizC8TxsAbDpdPdJqC7M=")
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token="Es58gKrbYKaAImQ2ltD7.511gSgvyAPO7ebgM9hm1LW.UjJEXyEZIBCi+NzqoQCkN2kuiQZNH4MFhoPfwj+EaCQ=)
km.loginResult()
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"︻デ═一 ▸")
                kk.sendText(msg.to,"︻デ═一 ▸")
                kc.sendText(msg.to,"︻デ═一 ▸")
                kr.sendText(msg.to,"︻デ═一 ▸)
                ks.sendText(msg.to,"︻デ═一 ▸")
                ka.sendText(msg.to,"︻デ═一 ▸")
                kb.sendText(msg.to,"︻デ═一 ▸")
                ko.sendText(msg.to,"︻デ═一 ▸")
                ke.sendText(msg.to,"︻デ═一 ▸")
